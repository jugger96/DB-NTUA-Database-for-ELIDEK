...
from dbdemo.forms import StudentForm, ResForm, CreResForm, ProjForm, SciForm, WorksForm, \
                        ...
                        CredeliverableForm, CreExForm, ExForm, psfForm, UpProjForm
...
def createRes():
    ...
    return render_template("researcher_create.html", pageTitle = "Create Researcher", form = form)
...
def createworker():
    ...
    ## else, response for GET request
    return render_template("worker_create.html", pageTitle = "Create Work Relation", form = form)
...
def createdeliverable():
    ...
    ## else, response for GET request
    return render_template("deliverable_create.html", pageTitle = "Create Deliverable", form = form)
...
def createpsf():
    ...
    ## else, response for GET request
    return render_template("psf_create.html", pageTitle = "Create Scientific Field - Project relation", form = form)
