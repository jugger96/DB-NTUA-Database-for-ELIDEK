...
delimiter $$
create trigger add_1st_worker after insert on project
for each row
begin
    INSERT into researcher_works_on_project (Researcher_ID,Project_ID) VALUES (new.researcher_id_default, new.id);
end;
$$
